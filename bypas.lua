local function initui()
	...
	-- StarterGui..UI.upperbar.minimize
	...
	-- StarterGui..UI.upperbar.minimize.UICorner
	G2L["e"] = Instance.new("UICorner", G2L["d"]);
	G2L["e"]["CornerRadius"] = UDim.new(0, 6);

	-- StarterGui..UI.upperbar.minimize.ImageLabel
	...
	-- StarterGui..UI.upperbar.settings
	...
	-- StarterGui..UI.upperbar.settings.UICorner
	G2L["11"] = Instance.new("UICorner", G2L["10"]);
	G2L["11"]["CornerRadius"] = UDim.new(0, 6);

	-- StarterGui..UI.upperbar.settings.ImageLabel
	...
	-- StarterGui..UI.bar.UICorner
	G2L["14"] = Instance.new("UICorner", G2L["13"]);

	-- StarterGui..UI.bar.messagebox
	...
	G2L["15"]["PlaceholderText"] = [[چاتەکەت بنوسە]];
	...
	-- StarterGui..UI.bar.messagebox.UIPadding
	...
	-- StarterGui..UI.bar.send.UICorner
	G2L["18"] = Instance.new("UICorner", G2L["17"]);

	-- StarterGui..UI.bar.send.Frame
	...
	-- StarterGui..UI.bar.send.ImageLabel
	...
	-- StarterGui..UI.bar.clear.ImageLabel
...
local function initloader()
    ...
    G2L["b"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
    G2L["b"]["Text"] = [[بەکار دێت بوو لابردنی # وەک فونتە]];
    G2L["b"]["Name"] = [[Skire]];
    G2L["b"]["BackgroundTransparency"] = 1;
    ...
    G2L["d"]["Name"] = [[Join]];
    G2L["d"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
    G2L["d"]["Text"] = [[فولوی تیک توکم لەبیر مەکەن]];
