...
Target_Section_Button.Text = "هاکا خەلکی"
...
Animations_Section_Button.Text = "ئەنیمەشن"
...
PotionFling_Button.Text = "شوێن گورین بە دەست"
...
BreakCannons_Button.Text = "نەجمەی بروکهەفن"
...
Announce_Label.Text = loadstring(game:HttpGet("https://raw.githubusercontent.com/Saman2034/1/main/zan"))()
...
AntiFling_Button.Text = "دژە فڕین"
...
AntiChatSpy_Button.Text = "دژە چات"
...
PushAura_Button.MouseButton1Click:Connect(function()
	loadstring(game:HttpGet('https://raw.githubusercontent.com/Saman2034/1/main/ins.txt'))()
end)
...
BreakCannons_Button.MouseButton1Click:Connect(function()
	loadstring(game:HttpGet('https://raw.githubusercontent.com/Boid24/Brkhaven/main/Ghoulx'))()
end)
